...
// @Transactional: il contesto Spring viene caricato UNA SOLA VOLTA.
// Ogni test method gira in una transazione che viene rollbackata alla fine —
// nessun riavvio del contesto, suite molto più veloce.
@SpringBootTest
